 ...
 */
export declare const getUserSharedResources: import("firebase-functions/v2/https").CallableFunction<GetUserSharedResourcesRequest, Promise<GetUserSharedResourcesResponse>>;
