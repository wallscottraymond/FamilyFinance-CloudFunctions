...
exports.unshareResource = void 0;
 ...
 */
exports.unshareResource = (0, https_1.onCall)({
    region: "us-central1",
    memory: "256MiB",
    timeoutSeconds: 30,
}, async (request) => {
    ...
    try {
        ...
        if (ownerId !== callerUserId) {
            throw new https_1.HttpsError('permission-denied', 'Only the resource owner can unshare resources');
        }
        ...
        // Update the resource
        await (0, firestore_1.updateDocument)(collectionName, resourceId, updateData);
        ...
        throw new https_1.HttpsError('internal', 'Failed to unshare resource');
    }
});
//# sourceMappingURL=unshareResource.js.map