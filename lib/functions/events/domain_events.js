...
function emit_domain_event(event, options = {}) {
    ...
    const full_event = Object.assign(Object.assign({}, event), { event_id: (0, observability_1.generate_id)(), created_at: firestore_1.Timestamp.fromMillis(now_ms), expire_at: firestore_1.Timestamp.fromMillis(now_ms + DOMAIN_EVENT_RETENTION_MS) });
