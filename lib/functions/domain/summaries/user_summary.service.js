...
function read_reconciliation(period) {
    var _a, _b, _c, _d;
    const rec = period.reconciliation;
    const status = (_a = rec === null || rec === void 0 ? void 0 : rec.status) !== null && _a !== void 0 ? _a : (period.isFullyPaid ? "complete" : period.isPartiallyPaid ? "partial" : "none");
    return {
        status,
        pendingAmount: (_b = rec === null || rec === void 0 ? void 0 : rec.pendingAmount) !== null && _b !== void 0 ? _b : 0,
        hasPending: (_d = (_c = rec === null || rec === void 0 ? void 0 : rec.hasPending) !== null && _c !== void 0 ? _c : period.hasPending) !== null && _d !== void 0 ? _d : false,
    };
}
/**
