 ...
 */
import { RetryAction, RetryDecisionInput } from "../../types/plaid/transient_error_retry.types";
/**
 ...
 * PURE FUNCTION.
 */
export declare function decide_retry_action(input: RetryDecisionInput): RetryAction;
//# sourceMappingURL=transient_error_retry.service.d.ts.map