 ...
 */
function compute_pending_expiration_update(now, consent_expiration_time) {
 ...
 * @returns Status update to apply
 */
function compute_error_update(now, error_code, error_message) {
 ...
 * @returns Status update to apply
 */
function compute_escalation_update(now, original_error_code) {
    return {
        status: item_status_webhook_types_1.ItemStatusValues.ITEM_LOGIN_REQUIRED,
 ...
 * @returns Status update to apply
 */
function compute_permission_revoked_update(now) {
    return {
