...
const category_semantics_service_1 = require("./category_semantics.service");
...
function compute_transaction_assignment(splits, context) {
    ...
    for (const split of splits) {
        ...
        const is_transfer = (0, category_semantics_service_1.is_transfer_category)(effective_detailed !== null && effective_detailed !== void 0 ? effective_detailed : resolved_plaid);
        let monthly_id;
        let weekly_id;
        let bi_weekly_id;
        let source;
        ...
        let outflow_source = "auto";
        if (split.outflow_source === "manual" &&
            split.outflow_id &&
...
function split_assignment_changed(before, after) {
    ...
    return (((_a = before.monthly_budget_id) !== null && _a !== void 0 ? _a : before.budget_id) !== after.monthly_budget_id ||
        ...
        ((_d = before.outflow_source) !== null && _d !== void 0 ? _d : "auto") !== after.outflow_source ||
        ...
        ((_e = before.overall_category_id) !== null && _e !== void 0 ? _e : null) !== after.overall_category_id ||
        ((_f = before.first_category_id) !== null && _f !== void 0 ? _f : null) !== after.first_category_id ||
        ((_g = before.second_category_id) !== null && _g !== void 0 ? _g : null) !== after.second_category_id ||
        ((_h = before.category_source) !== null && _h !== void 0 ? _h : "plaid") !== after.category_source);
}
