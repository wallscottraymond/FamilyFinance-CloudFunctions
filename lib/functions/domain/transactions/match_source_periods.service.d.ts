 ...
 * PURE FUNCTION.
 */
export declare function match_source_periods(txn_date_ms: number, source_periods: SourcePeriodForMatch[]): SourcePeriodMatchResult;
//# sourceMappingURL=match_source_periods.service.d.ts.map