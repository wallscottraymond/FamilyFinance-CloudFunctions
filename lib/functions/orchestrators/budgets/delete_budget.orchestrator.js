 ...
 * Deletes a budget.
 */
async function delete_budget_orchestrator(ctx, user_id, idempotency_key, budget_id, rollover_transfer_mode) {
    var _a;
    ...
    try {
        ...
        if (plan.requires_cascade) {
            ...
            const should_transfer = !!rollover_transfer_mode && dependencies.pending_rollover_by_type.length > 0;
            const payload = Object.assign({ budget_id,
                user_id, group_ids: dependencies.existing.group_ids, budget_period_ids: dependencies.budget_period_ids, affected_transaction_ids: dependencies.affected_transaction_ids, release_category_ids: plan.release_category_ids, everything_else_budget_id: dependencies.everything_else_budget_id, pending_rollover_by_type: dependencies.pending_rollover_by_type }, (should_transfer ? { rollover_transfer_mode } : {}));
