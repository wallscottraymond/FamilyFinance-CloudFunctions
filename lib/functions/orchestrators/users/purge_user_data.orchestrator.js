...
async function purge_user_data_orchestrator(ctx, input) {
    ...
    try {
        ...
        await record("budget_periods", await (0, purge_repo_1.hard_delete_by_fields_union)("budget_periods", ["ownerId", "userId"], user_id, writer, on_batch));
        await step("Deleting income history…");
        await record("inflow_periods", await (0, purge_repo_1.hard_delete_by_fields_union)("inflow_periods", ["ownerId", "userId"], user_id, writer, on_batch));
        await step("Deleting bill history…");
        await record("outflow_periods", await (0, purge_repo_1.hard_delete_by_fields_union)("outflow_periods", ["ownerId", "userId"], user_id, writer, on_batch));
        ...
        await record("transactions", await (0, purge_repo_1.hard_delete_by_fields_union)("transactions", ["ownerId", "userId"], user_id, writer, on_batch));
        await step("Deleting accounts…");
        await record("accounts", await (0, purge_repo_1.hard_delete_by_fields_union)("accounts", ["ownerId", "userId"], user_id, writer, on_batch));
        await step("Deleting recurring income…");
        await record("inflows", await (0, purge_repo_1.hard_delete_by_fields_union)("inflows", ["ownerId", "userId"], user_id, writer, on_batch));
        await step("Deleting recurring bills…");
        await record("outflows", await (0, purge_repo_1.hard_delete_by_fields_union)("outflows", ["ownerId", "userId"], user_id, writer, on_batch));
        await step("Deleting budgets…");
        await record("budgets", await (0, purge_repo_1.hard_delete_by_fields_union)("budgets", ["ownerId", "userId"], user_id, writer, on_batch));
        ...
        await record("user_summaries", await (0, purge_repo_1.hard_delete_by_fields_union)("user_summaries", ["ownerId", "userId"], user_id, writer, on_batch));
