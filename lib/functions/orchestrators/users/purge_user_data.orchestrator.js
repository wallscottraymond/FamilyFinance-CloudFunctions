...
async function purge_user_data_orchestrator(ctx, input) {
    ...
    try {
        ...
        await record("budget_periods", (await (0, purge_repo_1.hard_delete_by_field)("budget_periods", "ownerId", user_id, writer, on_batch)) +
            (await (0, purge_repo_1.hard_delete_by_field)("budget_periods", "userId", user_id, writer, on_batch)));
        await step("Deleting income history…");
        await record("inflow_periods", (await (0, purge_repo_1.hard_delete_by_field)("inflow_periods", "ownerId", user_id, writer, on_batch)) +
            (await (0, purge_repo_1.hard_delete_by_field)("inflow_periods", "userId", user_id, writer, on_batch)));
        await step("Deleting bill history…");
        await record("outflow_periods", (await (0, purge_repo_1.hard_delete_by_field)("outflow_periods", "ownerId", user_id, writer, on_batch)) +
            (await (0, purge_repo_1.hard_delete_by_field)("outflow_periods", "userId", user_id, writer, on_batch)));
        ...
        await record("transactions", (await (0, purge_repo_1.hard_delete_by_field)("transactions", "ownerId", user_id, writer, on_batch)) +
            (await (0, purge_repo_1.hard_delete_by_field)("transactions", "userId", user_id, writer, on_batch)));
        await step("Deleting accounts…");
        await record("accounts", (await (0, purge_repo_1.hard_delete_by_field)("accounts", "ownerId", user_id, writer, on_batch)) +
            (await (0, purge_repo_1.hard_delete_by_field)("accounts", "userId", user_id, writer, on_batch)));
        ...
        await record("user_summaries", (await (0, purge_repo_1.hard_delete_by_field)("user_summaries", "ownerId", user_id, writer, on_batch)) +
            (await (0, purge_repo_1.hard_delete_by_field)("user_summaries", "userId", user_id, writer, on_batch)));
