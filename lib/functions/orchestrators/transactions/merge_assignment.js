...
function merge_assignment_onto_raw_splits(resolved, result, now) {
    ...
    const updated_splits = resolved.raw_splits.map((raw) => {
        ...
        return Object.assign(Object.assign({}, raw), { 
            ...
            monthlyBudgetId: a.monthly_budget_id, weeklyBudgetId: a.weekly_budget_id, biWeeklyBudgetId: a.bi_weekly_budget_id, monthlyBudgetName: monthly_name !== null && monthly_name !== void 0 ? monthly_name : ((_a = raw.monthlyBudgetName) !== null && _a !== void 0 ? _a : null), weeklyBudgetName: weekly_name !== null && weekly_name !== void 0 ? weekly_name : ((_b = raw.weeklyBudgetName) !== null && _b !== void 0 ? _b : null), biWeeklyBudgetName: bi_weekly_name !== null && bi_weekly_name !== void 0 ? bi_weekly_name : ((_c = raw.biWeeklyBudgetName) !== null && _c !== void 0 ? _c : null), monthlyBudgetSource: a.budget_assignment_source, weeklyBudgetSource: a.budget_assignment_source, biWeeklyBudgetSource: a.budget_assignment_source, outflowId: a.outflow_id, 
            ...
            outflowAssignmentSource: a.outflow_source, inflowId: a.inflow_id, monthlyPeriodId: a.monthly_period_id, weeklyPeriodId: a.weekly_period_id, biWeeklyPeriodId: a.bi_weekly_period_id, 
