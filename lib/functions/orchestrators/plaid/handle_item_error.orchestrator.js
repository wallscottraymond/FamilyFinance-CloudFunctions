    ...
    try {
        ...
        switch (ctx.input.webhook_code) {
            case "PENDING_EXPIRATION":
                status_update = (0, item_status_webhook_service_1.compute_pending_expiration_update)(now, ctx.input.consent_expiration_time);
                break;
            case "ERROR":
                status_update = (0, item_status_webhook_service_1.compute_error_update)(now, ((_a = ctx.input.error) === null || _a === void 0 ? void 0 : _a.error_code) || "UNKNOWN_ERROR", (_b = ctx.input.error) === null || _b === void 0 ? void 0 : _b.error_message);
                break;
            case "USER_PERMISSION_REVOKED":
                status_update = (0, item_status_webhook_service_1.compute_permission_revoked_update)(now);
                break;
            default:
        ...
        await plaid_1.plaid_item_repo.apply_field_update(ctx, deps.item_doc_id, update_data);
        perf.writes++;
