 ...
 */
async function handleMembershipUpdate(label, groupId, beforeData, afterData) {
    try {
...
exports.onGroupMembershipUpdate = (0, firestore_1.onDocumentUpdated)({
    ...
    var _a, _b, _c, _d;
    await handleMembershipUpdate('onGroupMembershipUpdate', event.params.groupId, (_b = (_a = event.data) === null || _a === void 0 ? void 0 : _a.before) === null || _b === void 0 ? void 0 : _b.data(), (_d = (_c = event.data) === null || _c === void 0 ? void 0 : _c.after) === null || _d === void 0 ? void 0 : _d.data());
});
