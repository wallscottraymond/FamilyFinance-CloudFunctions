...
exports.onInflowCreated = (0, firestore_1.onDocumentCreated)({
    ...
    try {
        ...
        const inflowData = (_a = event.data) === null || _a === void 0 ? void 0 : _a.data();
        if (!inflowData) {
        ...
        for (const doc of sourcePeriodsSnapshot.docs) {
            ...
            const inflowPeriodDoc = {
                ...
                access: (0, documentStructure_1.inheritAccessControl)(inflowData.access, inflowData.userId),
                // === NESTED CATEGORIES OBJECT (inherited from parent) ===
                categories: (0, documentStructure_1.inheritCategories)(inflowData.categories),
                // === NESTED METADATA OBJECT (inherited + period-specific) ===
                metadata: Object.assign(Object.assign({}, (0, documentStructure_1.inheritMetadata)(inflowData.metadata, {
                    inheritedFrom: inflowId
                })), { lastCalculated: now, inflowDescription: inflowData.description, inflowMerchantName: inflowData.merchantName, inflowIsRegularSalary: inflowData.isRegularSalary }),
...
function calculatePaymentCycle(inflow) {
    ...
    const cycleStartDate = admin.firestore.Timestamp.fromDate(new Date(cycleEndDate.toDate().getTime() - (cycleDays * 24 * 60 * 60 * 1000)));
    return {
        incomeAmount,
        cycleDays,
        dailyRate,
