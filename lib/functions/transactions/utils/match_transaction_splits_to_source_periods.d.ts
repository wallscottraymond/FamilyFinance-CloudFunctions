 ...
 */
export declare function match_transaction_splits_to_source_periods(transactions: FamilyTransaction[]): Promise<FamilyTransaction[]>;
export { match_transaction_splits_to_source_periods as matchTransactionSplitsToSourcePeriods };
//# sourceMappingURL=match_transaction_splits_to_source_periods.d.ts.map