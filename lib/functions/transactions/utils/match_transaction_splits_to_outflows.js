...
exports.match_transaction_splits_to_outflows = match_transaction_splits_to_outflows;
...
async function match_transaction_splits_to_outflows(transactions, user_id) {
    ...
    try {
        ...
        const outflow_periods_snapshot = await index_1.db.collection('outflow_periods')
            .where('userId', '==', user_id)
            .where('isDuePeriod', '==', true)
            .where('expectedDueDate', '>=', firestore_1.Timestamp.fromDate(three_months_ago))
            .where('expectedDueDate', '<=', firestore_1.Timestamp.fromDate(one_month_forward))
            .get();
        ...
        const outflow_periods = outflow_periods_snapshot.docs.map(doc => {
            ...
            return {
                ...
                expected_due_date: data.expectedDueDate ? data.expectedDueDate.toMillis() : null,
                merchant_name: ((_a = data.metadata) === null || _a === void 0 ? void 0 : _a.outflowMerchantName) || null,
        ...
        transactions.forEach(transaction => {
            ...
            const merchant_name = (_a = transaction.merchantName) === null || _a === void 0 ? void 0 : _a.toLowerCase();
...
//# sourceMappingURL=match_transaction_splits_to_outflows.js.map