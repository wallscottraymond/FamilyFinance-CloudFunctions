...
exports.matchTransactionToBudget = exports.matchCategoriesToTransactions = void 0;
exports.formatTransactions = formatTransactions;
const firestore_1 = require("../../../utils/firestore");
const buildTransactionData_1 = require("./buildTransactionData");
/**
 ...
 */
async function formatTransactions(addedTransactions, itemId, userId, groupId, currency) {
    ...
    try {
        ...
        const accountQuery = await (0, firestore_1.queryDocuments)('accounts', {
            where: [
        ...
        for (const plaidTransaction of addedTransactions) {
            try {
                ...
                const formattedTransaction = await (0, buildTransactionData_1.buildTransactionData)(plaidTransaction, account, userId, groupId, currency, itemId);
...
var matchCategoriesToTransactions_1 = require("./matchCategoriesToTransactions");
Object.defineProperty(exports, "matchCategoriesToTransactions", { enumerable: true, get: function () { return matchCategoriesToTransactions_1.matchCategoriesToTransactions; } });
var matchTransactionToBudget_1 = require("./matchTransactionToBudget");
Object.defineProperty(exports, "matchTransactionToBudget", { enumerable: true, get: function () { return matchTransactionToBudget_1.matchTransactionToBudget; } });
//# sourceMappingURL=formatTransactions.js.map