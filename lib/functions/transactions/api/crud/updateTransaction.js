    ...
    return (0, cors_1.firebaseCors)(request, response, async () => {
        ...
        try {
            ...
            if (updateData.transactionDate) {
                return response.status(400).json((0, auth_1.createErrorResponse)("immutable-field", "Transaction date cannot be modified after creation. Please delete and recreate the transaction with the correct date."));
            }
            ...
            if (updateData.splits && updateData.splits.length > 0) {
                ...
                const tempTransaction = Object.assign(Object.assign(Object.assign({}, existingTransaction), updateData), { splits: updateData.splits || existingTransaction.splits, transactionDate: updateData.transactionDate
                ...
                const assignmentResult = await (0, assignTransactionSplits_1.assignTransactionSplits)(tempTransaction, user.id);
