...
exports.createTransaction = (0, https_1.onRequest)({
    ...
    return (0, cors_1.firebaseCors)(request, response, async () => {
        ...
        try {
            ...
            const assignmentResult = await (0, assignTransactionSplits_1.assignTransactionSplits)(transaction, user.id);
            ...
            const transactionsWithPeriods = await (0, matchTransactionSplitsToSourcePeriods_1.matchTransactionSplitsToSourcePeriods)([transactionWithBudgets]);
