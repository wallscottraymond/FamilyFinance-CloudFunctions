...
exports.verifyAccessControl = (0, https_1.onRequest)({
    ...
    const authResult = await (0, auth_1.authMiddleware)(req, auth_1.UserRole.ADMIN);
    if (!authResult.success) {
        res.status(401).json(authResult.error);
        return;
    }
    try {
        console.log(`🔍 Starting access control verification across all collections... (admin: ${(_a = authResult.user) === null || _a === void 0 ? void 0 : _a.email})`);
