...
exports.uploadCategoriesData = void 0;
...
exports.uploadCategoriesData = (0, https_1.onCall)({ cors: true }, async (request) => {
    var _a;
    ...
    if (!isAdmin) {
        ...
        throw new https_1.HttpsError('permission-denied', 'Only admins can upload categories');
    }
    try {
        ...
        for (let i = 0; i < categories.length; i += batchSize) {
            ...
            batchCategories.forEach((categoryId) => {
                ...
                batch.set(categoryRef, Object.assign(Object.assign({}, fullCategoriesData[categoryId]), { isActive: true }), { merge: true });
            });
            await batch.commit();
        ...
        throw new https_1.HttpsError('internal', 'Failed to upload categories: ' + error.message);
    }
});
//# sourceMappingURL=uploadCategoriesData.js.map