...
exports.generateSourcePeriods = void 0;
 ...
 * Admin only function
 */
exports.generateSourcePeriods = (0, https_1.onRequest)({
    region: "us-central1",
    memory: "512MiB",
    ...
    return (0, cors_1.firebaseCors)(request, response, async () => {
        ...
        try {
            ...
            for (let year = 2023; year <= 2033; year++) {
                ...
                for (let month = 1; month <= 12; month++) {
                    ...
                    const biMonthlyFirstHalf = {
                        ...
                        startDate: firestore_1.Timestamp.fromDate(startDate),
                        endDate: firestore_1.Timestamp.fromDate(firstHalfEnd),
                        year,
                    ...
                    const biMonthlySecondHalf = {
                        ...
                        type: types_1.PeriodType.BI_MONTHLY,
                        startDate: firestore_1.Timestamp.fromDate(secondHalfStart),
                        endDate: firestore_1.Timestamp.fromDate(endDate),
                        year,
                ...
                while (currentWeekStart.getUTCFullYear() === year || currentWeekStart < yearEnd) {
                    ...
                    if (weekEnd.getUTCFullYear() >= year && currentWeekStart.getUTCFullYear() <= year) {
                        ...
                        const weeklyPeriod = {
                            ...
                            startDate: firestore_1.Timestamp.fromDate(currentWeekStart),
                            endDate: firestore_1.Timestamp.fromDate(weekEnd),
                            year,
            ...
            return response.status(500).json((0, auth_1.createErrorResponse)("internal-error", "Failed to generate source periods"));
        }
    });
});
/**
...
//# sourceMappingURL=generateSourcePeriods.js.map