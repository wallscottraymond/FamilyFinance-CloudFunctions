...
const alignTransactionsToInflowPeriods_1 = require("../../inflow_periods/utils/alignTransactionsToInflowPeriods");
const predictNextPayment_1 = require("../../inflow_periods/utils/predictNextPayment");
...
exports.onInflowCreated = (0, firestore_1.onDocumentCreated)({
    ...
    try {
        ...
        const startDate = ((_c = inflowData.firstDate) === null || _c === void 0 ? void 0 : _c.toDate()) || new Date();
        ...
        for (const doc of sourcePeriodsSnapshot.docs) {
            ...
            const inflowPeriodDoc = {
                ...
                ownerId: userId,
                createdBy: isFlat ? inflowData.createdBy : (((_d = inflowData.metadata) === null || _d === void 0 ? void 0 : _d.createdBy) || userId),
                updatedBy: isFlat ? inflowData.createdBy : (((_e = inflowData.metadata) === null || _e === void 0 ? void 0 : _e.createdBy) || userId),
                groupId: groupId,
                // === PLAID IDENTIFIERS ===
                ...
                // === CATEGORIZATION ===
                internalDetailedCategory: isFlat ? inflowData.internalDetailedCategory : (((_f = inflowData.categories) === null || _f === void 0 ? void 0 : _f.detailed) || null),
                internalPrimaryCategory: isFlat ? inflowData.internalPrimaryCategory : (((_g = inflowData.categories) === null || _g === void 0 ? void 0 : _g.primary) || null),
                plaidPrimaryCategory: isFlat ? inflowData.plaidPrimaryCategory : (((_h = inflowData.categories) === null || _h === void 0 ? void 0 : _h.primary) || 'INCOME'),
                plaidDetailedCategory: isFlat ? inflowData.plaidDetailedCategory : (((_j = inflowData.categories) === null || _j === void 0 ? void 0 : _j.detailed) || ''),
                // === STATUS & CONTROL ===
                isActive: true,
                isHidden: false,
                // === MERCHANT INFO ===
        ...
        if (transactionIds.length > 0) {
            ...
            try {
                const alignmentResult = await (0, alignTransactionsToInflowPeriods_1.alignTransactionsToInflowPeriods)(db, inflowId, inflowData, inflowPeriods.map(p => p.id));
        ...
        try {
            const prediction = (0, predictNextPayment_1.predictNextPayment)(inflowData);
            if (prediction) {
