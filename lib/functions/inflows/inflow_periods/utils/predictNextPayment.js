 ...
 */
function calculateExpectedAmountByType(incomeType, averageAmount, inflow) {
    ...
    switch (incomeType) {
        ...
        case types_1.IncomeType.COMMISSION_ONLY:
            ...
            if (variableConfig === null || variableConfig === void 0 ? void 0 : variableConfig.useRollingAverage) {
        ...
        case types_1.IncomeType.BONUS:
            if ((bonusConfig === null || bonusConfig === void 0 ? void 0 : bonusConfig.lastBonusAmount) && bonusConfig.lastBonusAmount > 0) {
