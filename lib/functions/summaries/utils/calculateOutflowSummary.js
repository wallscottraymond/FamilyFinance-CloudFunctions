...
function calculateOutflowSummary(outflowPeriods) {
    ...
    const entries = outflowPeriods.map(outflowPeriod => {
        ...
        const rawPeriod = outflowPeriod;
        const merchantValue = rawPeriod.merchantName || outflowPeriod.merchant || "Unknown";
        ...
        return {
            ...
            hasPending: (_c = (_a = outflowPeriod.hasPending) !== null && _a !== void 0 ? _a : (_b = outflowPeriod.reconciliation) === null || _b === void 0 ? void 0 : _b.hasPending) !== null && _c !== void 0 ? _c : false,
