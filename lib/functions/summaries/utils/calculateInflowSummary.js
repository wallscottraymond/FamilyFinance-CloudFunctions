 ...
 */
function calculateInflowSummary(inflowPeriods, includeEntries = true // ALWAYS include entries for tile rendering
) {
    var _a;
    console.log(`[calculateInflowSummary] Calculating summary for ${inflowPeriods.length} inflow periods`);
    // Initialize totals
