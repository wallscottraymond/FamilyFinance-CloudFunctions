...
const doc_change_service_1 = require("../../domain/shared/doc_change.service");
...
exports.on_budget_period_updated_period_summary = (0, firestore_1.onDocumentUpdated)({
    ...
    if ((0, doc_change_service_1.only_ignored_changed)((_b = (_a = event.data) === null || _a === void 0 ? void 0 : _a.before) === null || _b === void 0 ? void 0 : _b.data(), (_d = (_c = event.data) === null || _c === void 0 ? void 0 : _c.after) === null || _d === void 0 ? void 0 : _d.data(), doc_change_service_1.PERIOD_SUMMARY_IGNORE_FIELDS)) {
        return;
    }
    ...
    try {
        const budget_period = (_e = event.data) === null || _e === void 0 ? void 0 : _e.after.data();
        if (!budget_period) {
