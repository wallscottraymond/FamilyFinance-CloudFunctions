...
const updateOutflowPeriodSummary_1 = require("../../outflows/outflow_summaries/crud/updateOutflowPeriodSummary");
const deleteOutflowPeriodSummary_1 = require("../../outflows/outflow_summaries/crud/deleteOutflowPeriodSummary");
/**
...
exports.onOutflowPeriodUpdatedPeriodSummary = (0, firestore_1.onDocumentUpdated)("outflow_periods/{outflowPeriodId}", async (event) => {
    ...
    try {
        // Update outflow summaries using dedicated function
        await (0, updateOutflowPeriodSummary_1.updateOutflowPeriodSummary)(outflowPeriod);
...
exports.onOutflowPeriodDeletedPeriodSummary = (0, firestore_1.onDocumentDeleted)("outflow_periods/{outflowPeriodId}", async (event) => {
    ...
    try {
        // Update outflow summaries after deletion using dedicated function
        await (0, deleteOutflowPeriodSummary_1.deleteOutflowPeriodSummary)(outflowPeriod);
