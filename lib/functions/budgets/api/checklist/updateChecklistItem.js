...
exports.updateChecklistItem = void 0;
const https_1 = require("firebase-functions/v2/https");
const admin = __importStar(require("firebase-admin"));
/**
 * Update an existing checklist item in a budget period
 */
exports.updateChecklistItem = (0, https_1.onCall)({
    region: 'us-central1',
    memory: '256MiB',
    timeoutSeconds: 30,
}, async (request) => {
    try {
        ...
        const { budgetPeriodId, checklistItemId, updates } = request.data;
        if (!budgetPeriodId || !checklistItemId || !updates) {
            throw new https_1.HttpsError('invalid-argument', 'budgetPeriodId, checklistItemId, and updates are required');
        }
        ...
        updatedChecklistItems[itemIndex] = Object.assign(Object.assign(Object.assign({}, updatedChecklistItems[itemIndex]), updates), { id: checklistItemId });
        ...
        throw new https_1.HttpsError('internal', 'Failed to update checklist item');
    }
});
//# sourceMappingURL=updateChecklistItem.js.map