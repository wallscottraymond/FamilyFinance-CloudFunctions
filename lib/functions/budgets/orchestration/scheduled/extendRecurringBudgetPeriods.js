        ...
        for (const budgetDoc of recurringBudgetsSnapshot.docs) {
            ...
            try {
                ...
                if (totalNewPeriods === 0) {
                    ...
                    const summaryUserId = ((_l = budget.access) === null || _l === void 0 ? void 0 : _l.createdBy) || budget.createdBy;
                    if (summaryUserId) {
                        try {
                            await (0, summaries_1.enqueue_user_summary_updates_from_budget_periods)({ trace_id: (0, uuid_1.v4)(), span_id: (0, uuid_1.v4)() }, summaryUserId, newPeriodIds);
                        }
                        catch (summaryError) {
