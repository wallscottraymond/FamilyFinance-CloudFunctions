...
exports.onBudgetPeriodUpdated = (0, firestore_1.onDocumentUpdated)({
    ...
    try {
        ...
        const spentChanged = ((_w = beforeData.spent) !== null && _w !== void 0 ? _w : 0) !== ((_x = afterData.spent) !== null && _x !== void 0 ? _x : 0);
        // Skip rollover recalculation if this is a rollover update (prevent infinite loop)
        const beforeRolloverCalcAt = (_0 = (_z = (_y = beforeData.rolloverCalculatedAt) === null || _y === void 0 ? void 0 : _y.toMillis) === null || _z === void 0 ? void 0 : _z.call(_y)) !== null && _0 !== void 0 ? _0 : 0;
        const afterRolloverCalcAt = (_3 = (_2 = (_1 = afterData.rolloverCalculatedAt) === null || _1 === void 0 ? void 0 : _1.toMillis) === null || _2 === void 0 ? void 0 : _2.call(_1)) !== null && _3 !== void 0 ? _3 : 0;
        ...
        console.log(`[onBudgetPeriodUpdated] Spent changed: ${spentChanged} (${(_4 = beforeData.spent) !== null && _4 !== void 0 ? _4 : 0} → ${(_5 = afterData.spent) !== null && _5 !== void 0 ? _5 : 0})`);
        ...
        if (spentChanged && !isRolloverUpdate) {
            ...
            const rolloverResult = await (0, rolloverChainCalculation_1.recalculateRolloverChain)(db, afterData.budgetId, periodId // Start from this period for efficiency
            );
