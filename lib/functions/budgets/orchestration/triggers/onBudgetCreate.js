...
const recalculateHistoricalTransactions_1 = require("../../utils/recalculateHistoricalTransactions");
...
exports.onBudgetCreate = (0, firestore_1.onDocumentCreated)({
    ...
    try {
        ...
        const userId = budgetData.userId || ((_b = budgetData.access) === null || _b === void 0 ? void 0 : _b.createdBy);
        if (!userId) {
        ...
        if (result.count > 0 && result.budgetPeriods.length > 0) {
            try {
                ...
                const summaries_updated = await (0, summaries_1.enqueue_user_summary_updates_from_budget_periods)(trace_context, userId, period_ids);
        ...
        try {
            ...
            const recalcResult = await (0, recalculateHistoricalTransactions_1.recalculateHistoricalTransactions)(budgetId, userId, budgetData.categoryIds || [], budgetData.startDate, endDate);
