...
async function increment_reads(ctx, count) {
    ...
    await db.runTransaction(async (tx) => {
        ...
        const current = (_b = (_a = snap.data()) === null || _a === void 0 ? void 0 : _a.reads) !== null && _b !== void 0 ? _b : 0;
        tx.set(doc_ref, { date: today, reads: current + count, updated_at: firestore_1.Timestamp.now() }, { merge: true });
    });
}
/**
...
async function increment_writes(ctx, count) {
    ...
    await db.runTransaction(async (tx) => {
        var _a, _b;
        const snap = await tx.get(doc_ref);
        const current = (_b = (_a = snap.data()) === null || _a === void 0 ? void 0 : _a.writes) !== null && _b !== void 0 ? _b : 0;
        tx.set(doc_ref, { date: today, writes: current + count, updated_at: firestore_1.Timestamp.now() }, { merge: true });
    });
}
/**
