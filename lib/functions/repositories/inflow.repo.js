...
function map_to_entity(doc) {
    ...
    return {
        ...
        occurrence_amount_overrides: (_c = doc.occurrenceAmountOverrides) !== null && _c !== void 0 ? _c : {},
        ...
        income_type: (_d = doc.incomeType) !== null && _d !== void 0 ? _d : "other",
        is_regular_salary: (_e = doc.isRegularSalary) !== null && _e !== void 0 ? _e : false,
        is_variable: false,
        status: "active",
        source: doc.source,
        plaid_status: (_f = doc.plaidStatus) !== null && _f !== void 0 ? _f : "UNKNOWN",
        plaid_confidence_level: (_g = doc.plaidConfidenceLevel) !== null && _g !== void 0 ? _g : null,
        is_hidden: doc.isHidden,
        is_user_modified: doc.isUserModified,
        transaction_ids: doc.transactionIds,
        tags: doc.tags,
        rules: doc.rules,
        removed_by_user: (_h = doc.removedByUser) !== null && _h !== void 0 ? _h : false,
...
function map_persistence_to_doc(entity, now, existing) {
    ...
    return {
        ...
        occurrenceAmountOverrides: (_d = existing === null || existing === void 0 ? void 0 : existing.occurrenceAmountOverrides) !== null && _d !== void 0 ? _d : {},
        currency: entity.currency,
        description: entity.description,
        merchantName: entity.payer_name,
        userCustomName: (_e = existing === null || existing === void 0 ? void 0 : existing.userCustomName) !== null && _e !== void 0 ? _e : entity.user_custom_name,
        ...
        internalPrimaryCategory: (_f = existing === null || existing === void 0 ? void 0 : existing.internalPrimaryCategory) !== null && _f !== void 0 ? _f : entity.internal_primary_category,
        internalDetailedCategory: (_g = existing === null || existing === void 0 ? void 0 : existing.internalDetailedCategory) !== null && _g !== void 0 ? _g : entity.internal_detailed_category,
...
exports.inflow_repo = {
    ...
    /**
     * Persist a user's remove/pause/restore state (removal intervals + denorm).
    ...
    async apply_period_suppression(ctx, id, intervals, user_id) {
        var _a;
        const db = (0, firestore_1.getFirestore)();
        const snap = await db.collection("inflow_periods").where("inflowId", "==", id).get();
        const now = firestore_1.Timestamp.now();
        let flipped = 0;
        let batch = db.batch();
        let batched = 0;
        ...
        if (batched > 0)
            await batch.commit();
        console.log(`[${ctx.trace_id}] inflow_repo.apply_period_suppression ${id}: flipped ${flipped}/${snap.size} periods (user ${user_id})`);
        return flipped;
    },
    /**
    ...
    async hard_delete(ctx, id, user_id) {
        ...
        return (0, types_1.create_write_result)("inflow", id, "replace", before, null);
    },
    /**
    ...
    /**
     * Mark recurring inflows as HIDDEN (durable exclusion of internal account
     * transfers). `isHidden` is preserved by `save_batch` across re-syncs. Idempotent.
     */
