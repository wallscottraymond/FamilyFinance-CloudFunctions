...
function map_persistence_to_doc(entity, now, existing) {
    ...
    return {
        ...
        removedByUser: (_k = existing === null || existing === void 0 ? void 0 : existing.removedByUser) !== null && _k !== void 0 ? _k : false,
        removalIntervals: (_l = existing === null || existing === void 0 ? void 0 : existing.removalIntervals) !== null && _l !== void 0 ? _l : [],
        lastSyncedAt: now,
    };
    /* eslint-enable @typescript-eslint/naming-convention */
}
