...
exports.transaction_repo = {
     ...
     */
    async pin_split_to_outflow(ctx, doc_id, split_id, outflow_id, user_id, clear_budget = false) {
        var _a;
        ...
        const splits = ((_a = before.splits) !== null && _a !== void 0 ? _a : []).map((s) => s.splitId === split_id
            ? Object.assign(Object.assign(Object.assign({}, s), { outflowId: outflow_id, 
                ...
                outflowAssignmentSource: outflow_id ? "manual" : "auto", inflowId: null }), (clear_budget ? { budgetId: "", budgetName: "" } : {})) : s);
