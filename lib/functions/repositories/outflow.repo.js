...
function map_to_entity(doc) {
    ...
    return {
        ...
        expense_type: (_b = doc.expenseType) !== null && _b !== void 0 ? _b : "other",
        is_essential: (_c = doc.isEssential) !== null && _c !== void 0 ? _c : false,
        type: doc.type,
        status: "active",
        source: doc.source,
        ...
        tags: doc.tags,
        rules: doc.rules,
        removed_by_user: (_f = doc.removedByUser) !== null && _f !== void 0 ? _f : false,
...
function map_persistence_to_doc(entity, now, existing) {
    ...
    return {
        ...
        type: (_f = existing === null || existing === void 0 ? void 0 : existing.type) !== null && _f !== void 0 ? _f : "recurring",
