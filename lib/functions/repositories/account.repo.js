    ...
    liabilities) {
        ...
        for (const chunk of chunks) {
            ...
            for (const plaid_account of chunk) {
                ...
                const liability_detail = liabilities === null || liabilities === void 0 ? void 0 : liabilities[plaid_account.account_id];
                if (existing) {
                    // UPDATE: balances (+ refresh liability detail when we have it).
                    const ref = doc_ref(existing.id);
                    /* eslint-disable @typescript-eslint/naming-convention */
                    const update_data = Object.assign({ currentBalance: new_balance, availableBalance: (_b = plaid_account.balances.available) !== null && _b !== void 0 ? _b : undefined, limit: (_c = plaid_account.balances.limit) !== null && _c !== void 0 ? _c : undefined, lastBalanceUpdate: now, updatedAt: now }, (liability_detail ? { liability: liability_detail } : {}));
                    /* eslint-enable @typescript-eslint/naming-convention */
