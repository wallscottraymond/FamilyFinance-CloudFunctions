...
exports.link_token_event_repo = void 0;
...
exports.link_token_event_repo = {
     ...
     */
    async get_valid_token(ctx, user_id, is_update_mode, options) {
        const db = get_db();
        ...
        try {
            ...
            const snapshot = await db
                ...
                .where("created_at", ">", firestore_1.Timestamp.fromDate(cutoff))
     ...
     */
    async get_by_user_id(ctx, user_id, limit = 10) {
        const db = get_db();
        const snapshot = await db
            .collection(COLLECTION)
            .where("user_id", "==", user_id)
...
//# sourceMappingURL=link_token_event.repo.js.map