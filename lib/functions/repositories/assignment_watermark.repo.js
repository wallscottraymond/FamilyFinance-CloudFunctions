...
exports.get_assignment_watermark_ms = get_assignment_watermark_ms;
exports.set_assignment_watermark_ms = set_assignment_watermark_ms;
const firestore_1 = require("firebase-admin/firestore");
const COLLECTION = "_assignment_watermarks";
/**
 * Read the user's assignment watermark (epoch ms), or `null` if none yet.
 */
async function get_assignment_watermark_ms(user_id) {
    var _a;
 ...
 */
async function set_assignment_watermark_ms(user_id, watermark_ms) {
    await (0, firestore_1.getFirestore)()
        .collection(COLLECTION)
        .doc(user_id)
        .set({ watermark_ms, updated_at: firestore_1.Timestamp.now() }, { merge: true });
}
//# sourceMappingURL=assignment_watermark.repo.js.map