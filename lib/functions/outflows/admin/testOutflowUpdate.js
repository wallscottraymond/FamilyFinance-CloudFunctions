...
exports.testOutflowUpdate = void 0;
const https_1 = require("firebase-functions/v2/https");
const admin = __importStar(require("firebase-admin"));
const firestore_1 = require("firebase-admin/firestore");
exports.testOutflowUpdate = (0, https_1.onRequest)({
    region: 'us-central1',
    memory: '256MiB',
    timeoutSeconds: 60,
}, async (req, res) => {
    ...
    try {
        const params = {
            outflowId: req.query.outflowId || '',
            newAmount: req.query.newAmount ? parseFloat(req.query.newAmount) : undefined,
            newCustomName: req.query.newCustomName || undefined,
        };
...
//# sourceMappingURL=testOutflowUpdate.js.map