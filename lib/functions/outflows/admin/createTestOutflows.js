...
const utils_1 = require("../outflow_main/utils");
    ...
    try {
        ...
        if (rawInflowStreams.length > 0) {
            ...
            try {
                ...
                const inflowResult = await (0, utils_1.batchCreateInflowStreams)(enhancedInflows, targetUserId);
        ...
        if (rawOutflowStreams.length > 0) {
            ...
            try {
                ...
                const formattedOutflows = await (0, utils_1.formatRecurringOutflows)(rawOutflowStreams, testPlaidItemId, targetUserId, testFamilyId);
                ...
                const enhancedOutflows = await (0, utils_1.enhanceRecurringOutflows)(formattedOutflows, targetUserId);
                ...
                console.log('');
                const outflowResult = await (0, utils_1.batchCreateOutflowStreams)(enhancedOutflows, targetUserId);
