...
exports.onOutflowPeriodDelete = void 0;
const firestore_1 = require("firebase-functions/v2/firestore");
const deleteOutflowPeriodSummary_1 = require("../../outflow_summaries/crud/deleteOutflowPeriodSummary");
/**
 * Triggered when an outflow_period is deleted
 * Updates summaries to reflect the deletion
 */
exports.onOutflowPeriodDelete = (0, firestore_1.onDocumentDeleted)({
    ...
    try {
        ...
        try {
            await (0, deleteOutflowPeriodSummary_1.deleteOutflowPeriodSummary)(outflowPeriodData);
...
//# sourceMappingURL=onOutflowPeriodDelete.js.map