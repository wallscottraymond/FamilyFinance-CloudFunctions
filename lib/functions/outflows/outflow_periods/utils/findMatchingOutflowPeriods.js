...
exports.findMatchingOutflowPeriods = findMatchingOutflowPeriods;
exports.validatePeriodsFound = validatePeriodsFound;
exports.getAllPeriodIds = getAllPeriodIds;
exports.findMatchingOutflowPeriodsBySourcePeriod = findMatchingOutflowPeriodsBySourcePeriod;
 ...
 */
async function findMatchingOutflowPeriods(db, outflowId, transactionDate) {
    ...
    periodsSnapshot.forEach(doc => {
        ...
        else if (periodType === types_1.PeriodType.WEEKLY) {
 ...
 */
function validatePeriodsFound(result) {
 ...
 */
function getAllPeriodIds(result) {
    const periodIds = [];
    if (result.monthlyPeriodId)
        periodIds.push(result.monthlyPeriodId);
    if (result.weeklyPeriodId)
        periodIds.push(result.weeklyPeriodId);
    if (result.biWeeklyPeriodId)
        periodIds.push(result.biWeeklyPeriodId);
    return periodIds;
}
/**
 ...
 * @returns MatchingOutflowPeriodsResult with all three period IDs (null if not found)
 */
async function findMatchingOutflowPeriodsBySourcePeriod(db, outflowId, targetPeriodId) {
    ...
    const periodStartDate = sourcePeriod === null || sourcePeriod === void 0 ? void 0 : sourcePeriod.startDate;
    const periodEndDate = sourcePeriod === null || sourcePeriod === void 0 ? void 0 : sourcePeriod.endDate;
...
//# sourceMappingURL=findMatchingOutflowPeriods.js.map