        ...
        for (let i = 0; i < periodsToUpdate.length; i += batchSize) {
            ...
            for (const periodDoc of batchPeriods) {
                    ...
                    if (period.occurrences && period.occurrences.length > 0) {
                        updates.occurrences = period.occurrences.map(occ => {
                            if (occ.isPaid) {
                                ...
                                return Object.assign(Object.assign({}, occ), { amountDue: outflowAfter.averageAmount });
                            }
                        });
                ...
                if (changedFields.includes('isEssential')) {
                    updates.isEssential = (_a = outflowAfter.isEssential) !== null && _a !== void 0 ? _a : false;
                ...
                if (changedFields.includes('isActive') && !isPaid) {
                    updates.isActive = (_b = outflowAfter.isActive) !== null && _b !== void 0 ? _b : true;
