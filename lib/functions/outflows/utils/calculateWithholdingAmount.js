...
exports.calculatePaymentCycle = calculatePaymentCycle;
exports.calculateWithholdingAmount = calculateWithholdingAmount;
exports.getDailyWithholdingRate = getDailyWithholdingRate;
exports.calculateTotalWithholding = calculateTotalWithholding;
 ...
 */
function calculateMonthlyWithholding(monthlyAmount, targetPeriod) {
 ...
 * ```
 */
function calculatePaymentCycle(outflow) {
    ...
    console.log(`[calculatePaymentCycle] ${outflow.description}: ` +
 ...
 * ```
 */
function calculateWithholdingAmount(sourcePeriod, cycleInfo, outflow) {
    ...
    switch (cycleInfo.frequency) {
        case types_1.PlaidRecurringFrequency.MONTHLY:
            ...
            console.log(`[calculateWithholdingAmount] ${outflow.description} - Period: ${sourcePeriod.id}, ` +
        ...
        default:
            ...
            console.warn(`[calculateWithholdingAmount] Unknown frequency ${cycleInfo.frequency}, using fallback calculation`);
    }
    ...
    const dueDate = isDuePeriod ? firestore_1.Timestamp.fromDate(cycleEnd) : undefined;
    if (isDuePeriod) {
        console.log(`[calculateWithholdingAmount] ${outflow.description} - DUE in ${sourcePeriod.id}: ` +
 ...
 */
function getDailyWithholdingRate(outflow) {
    const cycleInfo = calculatePaymentCycle(outflow);
 ...
 */
function calculateTotalWithholding(sourcePeriods, cycleInfo, outflow) {
    let total = 0;
...
//# sourceMappingURL=calculateWithholdingAmount.js.map