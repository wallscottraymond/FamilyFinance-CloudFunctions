...
exports.updatePeriodNames = updatePeriodNames;
/**
 ...
 */
function updatePeriodNames(params) {
    ...
    let updatedCount = 0;
    const updatedPeriods = Object.assign({}, currentPeriods);
    ...
    for (const sourcePeriodId in updatedPeriods) {
        ...
        updatedPeriods[sourcePeriodId] = entries.map(entry => {
            if (entry.outflowId === outflowId) {
                updatedCount++;
                return Object.assign(Object.assign({}, entry), { merchant,
                    userCustomName });
            }
            return entry;
        });
...
//# sourceMappingURL=updatePeriodNames.js.map