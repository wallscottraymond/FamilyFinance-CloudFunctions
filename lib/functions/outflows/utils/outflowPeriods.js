...
const calculateWithholdingAmount_1 = require("./calculateWithholdingAmount");
const calculateAllOccurrencesInPeriod_1 = require("./calculateAllOccurrencesInPeriod");
/**
...
startDate, endDate) {
    ...
    const cycleInfo = (0, calculateWithholdingAmount_1.calculatePaymentCycle)(outflow);
    ...
    for (const doc of overlappingPeriods) {
        ...
        const occurrences = (0, calculateAllOccurrencesInPeriod_1.calculateAllOccurrencesInPeriod)(outflow, sourcePeriod);
        // Calculate withholding amounts for this period
        const periodCalc = (0, calculateWithholdingAmount_1.calculateWithholdingAmount)(sourcePeriod, cycleInfo, outflow);
...
//# sourceMappingURL=outflowPeriods.js.map