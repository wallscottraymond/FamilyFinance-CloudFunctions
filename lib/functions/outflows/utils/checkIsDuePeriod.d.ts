 ...
 * ```
 */
export declare function checkIsDuePeriod(expectedDueDate: Timestamp, periodStartDate: Timestamp, periodEndDate: Timestamp): boolean;
//# sourceMappingURL=checkIsDuePeriod.d.ts.map