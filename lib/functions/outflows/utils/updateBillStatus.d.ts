 ...
 * ```
 */
export declare function updateBillStatus(isDuePeriod: boolean, dueDate: Timestamp | undefined, expectedDueDate: Timestamp): string;
//# sourceMappingURL=updateBillStatus.d.ts.map