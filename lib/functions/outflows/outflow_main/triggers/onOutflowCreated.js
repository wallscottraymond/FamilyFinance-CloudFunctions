...
exports.onOutflowCreated = (0, firestore_1.onDocumentCreated)({
    ...
    try {
        ...
        const { startDate, endDate } = (0, createOutflowPeriods_1.calculatePeriodGenerationRange)(outflowData, 15);
        ...
        const result = await (0, createOutflowPeriods_1.createOutflowPeriodsFromSource)(db, outflowId, outflowData, startDate, endDate);
        console.log('');
