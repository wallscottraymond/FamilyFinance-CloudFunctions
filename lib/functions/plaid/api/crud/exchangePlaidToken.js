...
const plaidClient_1 = require("../../../../utils/plaidClient");
...
async function handleTokenExchange(req, res) {
    try {
        ...
        const { accessToken, itemId } = await (0, plaidClient_1.exchangePublicToken)(plaidClient, requestData.publicToken);
        ...
        const accounts = await (0, plaidAccounts_1.fetchPlaidAccounts)(plaidClient, accessToken, itemId);
        ...
        await (0, plaidAccounts_1.savePlaidAccounts)(accounts, itemId, user.uid, requestData.metadata.institution.institution_id, requestData.metadata.institution.name, groupId);
