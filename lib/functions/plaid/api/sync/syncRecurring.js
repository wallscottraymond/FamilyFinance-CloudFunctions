...
const utils_1 = require("../../../outflows/outflow_main/utils");
// Define secrets
...
async function syncRecurringTransactions(plaidItemId, userId) {
    ...
    try {
        ...
        if (rawOutflowStreams.length > 0) {
            ...
            const formattedOutflows = await (0, utils_1.formatRecurringOutflows)(rawOutflowStreams, plaidItemId, userId, itemData.familyId);
