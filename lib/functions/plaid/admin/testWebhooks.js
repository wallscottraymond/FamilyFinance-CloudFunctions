...
exports.getUserPlaidItems = exports.clearItemError = exports.resetItemLogin = exports.fireItemWebhook = exports.fireIncomeWebhook = exports.fireTransactionWebhook = void 0;
 ...
 */
exports.resetItemLogin = (0, https_1.onCall)({
    memory: '256MiB',
    timeoutSeconds: 30,
    secrets: [plaidClientId, plaidSecret],
}, async (request) => {
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', error.message || 'Failed to reset item login');
    }
});
/**
 ...
 */
exports.clearItemError = (0, https_1.onCall)({
    memory: '256MiB',
    timeoutSeconds: 30,
}, async (request) => {
    try {
        ...
        throw new https_1.HttpsError('internal', error.message || 'Failed to clear item error');
    }
});
/**
 * Get user's Plaid items for webhook testing
