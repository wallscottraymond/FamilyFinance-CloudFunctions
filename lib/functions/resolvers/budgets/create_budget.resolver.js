...
async function resolve_create_budget_dependencies(ctx, user_id, input) {
    ...
    const target_cadence = (0, budgets_1.budget_cadence_to_instance)(input.period);
    const ee_budgets = budgets.filter((b) => b.is_system_everything_else === true);
    const everything_else = (_h = (_g = ee_budgets.find((b) => (0, budgets_1.budget_cadence_to_instance)(b.period) === target_cadence)) !== null && _g !== void 0 ? _g : ee_budgets[0]) !== null && _h !== void 0 ? _h : null;
    ...
    return {
        ...
        category_owners,
        everything_else_budget_id: (_j = everything_else === null || everything_else === void 0 ? void 0 : everything_else.id) !== null && _j !== void 0 ? _j : null,
    };
}
