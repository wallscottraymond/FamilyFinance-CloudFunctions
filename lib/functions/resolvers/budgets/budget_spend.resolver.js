    ...
    for (const { data: d } of txns) {
        ...
        for (const s of splits) {
            ...
            out.push({
                ...
                spend_status: (_c = s.spendStatus) !== null && _c !== void 0 ? _c : (s.isIgnored === true
                    ? "ignored"
                    : s.isRefund === true
                        ? "refund"
                        : "counted"),
                outflow_id: (_d = s.outflowId) !== null && _d !== void 0 ? _d : null,
                inflow_id: (_e = s.inflowId) !== null && _e !== void 0 ? _e : null,
            });
        }
    }
    return out;
