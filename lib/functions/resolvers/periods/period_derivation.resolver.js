...
async function resolve_period_derivation_deps(ctx, user_id, view_cadence, window_start_ms, window_end_ms) {
    ...
    for (const i of inflows) {
        ...
        for (const tx_id of (_c = i.transaction_ids) !== null && _c !== void 0 ? _c : []) {
    ...
    for (const { id, data } of txns) {
        ...
        const plaid_txn_id = (_d = data.transactionId) !== null && _d !== void 0 ? _d : null;
        const linked_inflow_id = plaid_txn_id ? inflow_tx_to_id.get(plaid_txn_id) : undefined;
        let income_amount = 0;
        const raw = (_e = data.splits) !== null && _e !== void 0 ? _e : [];
        for (const s of raw) {
            const outflow_id = (_f = s.outflowId) !== null && _f !== void 0 ? _f : null;
            const inflow_id = (_g = s.inflowId) !== null && _g !== void 0 ? _g : null;
            const amount = (_h = s.amount) !== null && _h !== void 0 ? _h : 0;
            const split_id = (_k = (_j = s.splitId) !== null && _j !== void 0 ? _j : s.id) !== null && _k !== void 0 ? _k : null;
    ...
    for (const r of recurring) {
        r.payments = (_l = payments_by_id.get(r.id)) !== null && _l !== void 0 ? _l : [];
    }
