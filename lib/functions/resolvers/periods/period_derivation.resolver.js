...
async function resolve_period_derivation_deps(ctx, user_id, view_cadence, window_start_ms, window_end_ms) {
    ...
    for (const o of outflows) {
        ...
        recurring.push({
            ...
            schedule: {
                ...
                average_amount: (_c = o.expected_amount_override) !== null && _c !== void 0 ? _c : o.average_amount,
        ...
        outflow_stream_items.push({ id: o.id, transaction_ids: (_d = o.transaction_ids) !== null && _d !== void 0 ? _d : [] });
    }
    ...
    for (const i of inflows) {
        ...
        recurring.push({
            ...
            schedule: {
                ...
                // User override ("this + future") wins over Plaid's average when set.
                average_amount: (_e = i.expected_amount_override) !== null && _e !== void 0 ? _e : i.average_amount,
        ...
        inflow_stream_items.push({ id: i.id, transaction_ids: (_f = i.transaction_ids) !== null && _f !== void 0 ? _f : [] });
    }
    ...
    for (const { id, data } of txns) {
        ...
        const plaid_txn_id = (_g = data.transactionId) !== null && _g !== void 0 ? _g : null;
        ...
        let income_amount = 0;
        const raw = (_h = data.splits) !== null && _h !== void 0 ? _h : [];
        for (const s of raw) {
            const outflow_id = (_j = s.outflowId) !== null && _j !== void 0 ? _j : null;
            const inflow_id = (_k = s.inflowId) !== null && _k !== void 0 ? _k : null;
            const amount = (_l = s.amount) !== null && _l !== void 0 ? _l : 0;
            const split_id = (_o = (_m = s.splitId) !== null && _m !== void 0 ? _m : s.id) !== null && _o !== void 0 ? _o : null;
        ...
        const txn_cat = (_r = (_p = data.plaidDetailedCategory) !== null && _p !== void 0 ? _p : (_q = raw[0]) === null || _q === void 0 ? void 0 : _q.plaidDetailedCategory) !== null && _r !== void 0 ? _r : "";
    ...
    for (const r of recurring) {
        r.payments = (_s = payments_by_id.get(r.id)) !== null && _s !== void 0 ? _s : [];
    }
    ...
    if (inflow_tx_ids.length > 0) {
        ...
        for (const d of hist_docs) {
            ...
            if (!inflow_id)
                continue;
            const splits = (_t = d.splits) !== null && _t !== void 0 ? _t : [];
            ...
            const list = (_u = history_by_inflow.get(inflow_id)) !== null && _u !== void 0 ? _u : [];
            list.push({ date_ms, amount });
            history_by_inflow.set(inflow_id, list);
        }
        for (const r of recurring) {
            if (r.kind === "inflow")
                r.payment_history = (_v = history_by_inflow.get(r.id)) !== null && _v !== void 0 ? _v : [];
        }
    }
