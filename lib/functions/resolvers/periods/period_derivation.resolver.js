...
async function resolve_period_derivation_deps(ctx, user_id, view_cadence, window_start_ms, window_end_ms) {
    ...
    for (const i of inflows) {
        ...
        recurring.push({
            ...
            schedule: {
                ...
                // User override ("this + future") wins over Plaid's average when set.
                average_amount: (_d = i.expected_amount_override) !== null && _d !== void 0 ? _d : i.average_amount,
        ...
        for (const tx_id of (_e = i.transaction_ids) !== null && _e !== void 0 ? _e : []) {
    ...
    for (const { id, data } of txns) {
        ...
        const plaid_txn_id = (_f = data.transactionId) !== null && _f !== void 0 ? _f : null;
        ...
        for (const s of raw) {
            ...
            const amount = (_k = s.amount) !== null && _k !== void 0 ? _k : 0;
            const split_id = (_m = (_l = s.splitId) !== null && _l !== void 0 ? _l : s.id) !== null && _m !== void 0 ? _m : null;
    ...
    for (const r of recurring) {
        r.payments = (_o = payments_by_id.get(r.id)) !== null && _o !== void 0 ? _o : [];
    }
