...
exports.onUserCreate = functions.region("us-central1").runWith({
    ...
    try {
        ...
        const userData = {
            ...
            role: types_1.UserRole.EDITOR, // Default role - allows users to create budgets/transactions
        ...
        (0, createEverythingElseBudget_1.createEverythingElseBudget)(db, userRecord.uid, detectedCurrency).then((budgetId) => {
