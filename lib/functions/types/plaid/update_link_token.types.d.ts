 ...
 */
export declare const MAX_RELINK_ATTEMPTS_BEFORE_HELP = 3;
/**
 * Time window for counting recent re-link attempts (hours).
 */
export declare const RELINK_ATTEMPT_WINDOW_HOURS = 24;
/**
 * Retention period for relink attempt records (days).
 */
export declare const RELINK_ATTEMPT_RETENTION_DAYS = 30;
/**
 * Performance budget for create_update_link_token orchestrator.
 */
export declare const CREATE_UPDATE_LINK_TOKEN_BUDGET: {
    max_reads: number;
    max_writes: number;
    max_time_ms: number;
};
 ...
 */
export declare const STATUSES_REQUIRING_REAUTH: PlaidItemStatus[];
/**
 * Error messages for specific item statuses.
 */
export declare const STATUS_ERROR_MESSAGES: Record<string, string>;
//# sourceMappingURL=update_link_token.types.d.ts.map