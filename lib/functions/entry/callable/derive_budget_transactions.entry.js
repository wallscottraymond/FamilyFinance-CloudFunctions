...
{ maxInstances: 100 }, async (request) => {
    ...
    try {
        ...
        const rows = await (0, derive_budget_transactions_orchestrator_1.derive_budget_transactions_orchestrator)(ctx, user_id, input.budget_id, input.window_start_ms, input.window_end_ms, (_b = input.force) !== null && _b !== void 0 ? _b : false);
