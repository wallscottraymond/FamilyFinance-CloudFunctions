...
exports.manage_recurring_outflow = void 0;
...
const schema = zod_1.z.intersection(zod_1.z.object({
    outflow_id: zod_1.z.string().min(1, "outflow_id is required"),
...
exports.manage_recurring_outflow = (0, https_1.onCall)(
...
{ maxInstances: 50 }, async (request) => {
    ...
    const span = (0, observability_1.create_span)(ctx, "entry", "manage_recurring_outflow");
    ...
    try {
        ...
        const result = await (0, manage_recurring_removal_orchestrator_1.manage_recurring_removal_orchestrator)(ctx, user_id, user_group_ids, input, now_ms, outflow_repo_1.outflow_repo, "recurring_outflow");
        ...
        throw new https_1.HttpsError("internal", "Failed to manage recurring outflow", {
            trace_id: ctx.trace_id,
        });
    }
});
//# sourceMappingURL=manage_recurring_outflow.entry.js.map