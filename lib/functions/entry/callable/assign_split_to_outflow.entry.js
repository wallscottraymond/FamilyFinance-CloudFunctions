...
const schema = zod_1.z.object({
    ...
    outflow_period_id: zod_1.z.string().min(1).nullable().optional(),
...
{ maxInstances: 50 }, async (request) => {
    ...
    try {
        ...
        const { transaction_id, split_id, outflow_id, outflow_period_id, clear_budget } = validation.data;
        await transaction_repo_1.transaction_repo.pin_split_to_outflow(ctx, transaction_id, split_id, outflow_id, user_id, clear_budget === true, outflow_period_id !== null && outflow_period_id !== void 0 ? outflow_period_id : null);
        ...
        await (0, derive_version_repo_1.bump_derive_version)(user_id).catch(() => { });
        (0, observability_1.log_operation_success)(span, user_id);
        return (0, types_1.success_response)({ transaction_id, split_id, outflow_id, outflow_period_id: outflow_period_id !== null && outflow_period_id !== void 0 ? outflow_period_id : null }, ctx.trace_id);
    }
    catch (error) {
