...
exports.on_budget_period_edited = (0, firestore_1.onDocumentUpdated)({
    ...
    const bf = before;
    const af = after;
    const relevant_changed = before.userNotes !== after.userNotes ||
        JSON.stringify((_c = bf.checklistItems) !== null && _c !== void 0 ? _c : []) !== JSON.stringify((_d = af.checklistItems) !== null && _d !== void 0 ? _d : []) ||
    ...
    const owner = ((_e = af.userId) !== null && _e !== void 0 ? _e : af.ownerId);
    if (owner)
