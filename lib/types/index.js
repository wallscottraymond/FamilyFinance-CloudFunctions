...
(function (BudgetPeriod) {
    ...
    BudgetPeriod["BI_MONTHLY"] = "bi_monthly";
...
(function (PlaidWebhookCode) {
    ...
    PlaidWebhookCode["LOGIN_REPAIRED"] = "LOGIN_REPAIRED";
...
(function (PlaidRecurringFrequency) {
    ...
    PlaidRecurringFrequency["QUARTERLY"] = "QUARTERLY";
...
(function (IncomeType) {
    ...
    IncomeType["BASE_PLUS_COMMISSION"] = "base_plus_commission";
    IncomeType["COMMISSION_ONLY"] = "commission_only";
    ...
    IncomeType["GOVERNMENT"] = "government";
 ...
 */
var IncomeVariability;
(function (IncomeVariability) {
    IncomeVariability["FIXED"] = "fixed";
    IncomeVariability["LOW"] = "low";
    IncomeVariability["MEDIUM"] = "medium";
    IncomeVariability["HIGH"] = "high"; // Highly variable (commission-only, bonus, freelance)
})(IncomeVariability || (exports.IncomeVariability = IncomeVariability = {}));
