...
__exportStar(require("./functions/sharing"), exports); // Legacy group management (onRequest, familyId) - DEPRECATED
__exportStar(require("./functions/groups"), exports); // RBAC v2 group management (onCall, groupIds[])
...
__exportStar(require("./functions/summaries"), exports); // Period-centric summary system (API + triggers)
__exportStar(require("./functions/entry"), exports); // New layered architecture entry points (accounts, etc.)
